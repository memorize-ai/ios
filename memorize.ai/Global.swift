...
class Card {
	...
	init(id: String, front: String, back: String, count: Int, correct: Int, streak: Int, mastered: Bool, last: Date, next: Date, lastHistory: String, history: [History], deck: String) {
		self.id = id
		self.front = front
		self.back = back
		self.count = count
